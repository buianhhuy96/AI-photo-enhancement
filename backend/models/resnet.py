"""ResNet backbone for BiSeNet face parsing.
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        layers = [block(self.in_channels, planes, stride, downsample, self.groups,
...
def resnet18(*, weights=ResNet18_Weights.DEFAULT, progress=True, **kwargs):
    weights = ResNet18_Weights.verify(weights)
    return _resnet(BasicBlock, [2, 2, 2, 2], weights, progress, **kwargs)


def resnet34(*, weights=ResNet34_Weights.DEFAULT, progress=True, **kwargs):
